...
That is the goal, however since we do not have access to the source code, we cannot know for sure. What we can know, is if the binary produced has the same hash as the official game binary, and with this we can tell how accurate our code is to the official game's code.
